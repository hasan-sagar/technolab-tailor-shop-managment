                ...
                <div class="box">
                    ...
                    <form method="POST" action="{{ route('update.service') }}">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="service_name" type="text" value="{{$service->service_name}}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="service_code" type="text" value="{{$service->service_code}}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="category_id mb-2">Category</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="selling_price" type="number" value="{{$service->selling_price}}"
                            ...
                            <div>
                                <input type="submit" value="Update Service" class="btn btn-success text-white">
                            </div>
                        </div>
                        <!-- /.box-body -->
                    </form>
